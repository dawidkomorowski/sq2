...
internal class SQ2Game : Game
{
    ...
    public override void RegisterComponents(IComponentsRegistry componentsRegistry)
    {
        ...
        componentsRegistry.RegisterSingleInstance<GameStateService>();
        ...
        componentsRegistry.RegisterComponentFactory<Bat2EnemyComponentFactory>();
        // Level Geometry
        ...
        componentsRegistry.RegisterComponentFactory<SettingsViewComponentFactory>();
        componentsRegistry.RegisterComponentFactory<StatsViewComponentFactory>();
