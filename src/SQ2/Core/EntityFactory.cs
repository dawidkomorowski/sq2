...
internal sealed class EntityFactory
{
    ...
    public Entity CreateBlueEnemy(Scene scene, Vector2 position, MovementDirection initialMovementDirection, bool requireActivation)
    {
        var entity = scene.CreateEntity();
    ...
    public Entity CreateRedEnemy(Scene scene, Vector2 position, MovementDirection initialMovementDirection)
    {
        var entity = scene.CreateEntity();
